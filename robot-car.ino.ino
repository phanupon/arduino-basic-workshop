...
const int trigPin = 9; // 10 microsecond high pulse causes chirp , wait 50 us
const int echoPin = 8; // Width of high pulse indicates distance
// Servo motor that aims ultrasonic sensor .
const int servoPin = 1; // PWM output for hobby servo
// Motor control pins : L298N H bridge
//const int enAPin = 6; // Left motor PWM speed control
const int in1Pin = 5; // Left motor Direction 1
const int in2Pin = 6; // Left motor Direction 2
const int in3Pin = 10; // Right motor Direction 1
const int in4Pin = 11; // Right motor Direction 2
